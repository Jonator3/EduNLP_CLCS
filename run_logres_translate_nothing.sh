...
python3 main.py --output ./result/logres/translate_nothing.csv --testset ASAP_orig en ASAP_orig en 1 --lowercase
python3 main.py --output ./result/logres/translate_nothing.csv --testset ASAP_orig en ASAP_orig en 2 --lowercase
python3 main.py --output ./result/logres/translate_nothing.csv --testset ASAP_orig en ASAP_orig en 10 --lowercase
